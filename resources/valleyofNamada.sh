...
- current namada node version: ${CYAN}v1.0.0 - v1.1.1 - v1.1.5 - v101.1.4 - v101.1.7${RESET}
...
function install_namada_app() {
    ...
    wget https://github.com/anoma/namada/releases/download/v101.1.4/namada-v101.1.4-Linux-x86_64.tar.gz
    tar -xvf namada-v101.1.4-Linux-x86_64.tar.gz
    cd namada-v101.1.4-Linux-x86_64
...
function show_guidelines() {
    ...
    echo "   - Install Namada App (v101.1.4) to execute transactions without running a node"
...
function menu() {
    ...
    echo -e "${GREEN}6. Install the Namada App (v101.1.4) only to execute transactions without running a node${RESET}"
